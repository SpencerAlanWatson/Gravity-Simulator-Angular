        ...
        forProps = function (object, callback, options) {
            ...
            // else iterate only enumerable properties
                ...
                for (key in object) {
                    ...
                    if ((done = !(skipProto && key == 'prototype') &&
        ...
        do {
            ...
            if (value === Object(value)) {
                ...
                if (isClassOf(value.deepClone, 'Function')) {
                    ...
                    case '[object RegExp]':
                        clone = ctor(value.source, (value.global ? 'g' : '') +
                            (value.ignoreCase ? 'i' : '') +
                            (value.multiline ? 'm' : ''));
                    }
                }
    ...
    function clock() {
        ...
        clock = function (clone) {
            ...
            var compiled = bench.compiled = createFunction(preprocess('t$'), interpolate(
                preprocess(deferred ? 'var d$=this,#{fnArg}=d$,m$=d$.benchmark._original,f$=m$.fn,su$=m$.setup,td$=m$.teardown;' +
            ...
            if (decompilable && !compiled && !deferred && !isEmpty) {
                compiled = createFunction(preprocess('t$'), interpolate(
                    preprocess(
                        (clone.error && !stringable ? 'var r$,s$,m$=this,f$=m$.fn,i$=m$.count' : 'function f$(){#{fn}\n}var r$,s$,m$=this,i$=m$.count') +
